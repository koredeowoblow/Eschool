...
use App\Http\Controllers\Api\AccountLinkingController;
...
Route::middleware(['auth:sanctum'])->group(function () {
    ...
    Route::post('guardians', [UserController::class, 'store']);
    ...
    // Account Linking
    Route::post('account/link/initiate', [AccountLinkingController::class, 'initiate']);
    Route::post('account/link/verify', [AccountLinkingController::class, 'verify']);
